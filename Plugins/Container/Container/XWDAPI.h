...
#define XWDAPIVERSION 0x00000002 // 0.0.0.2
...
enum XWDFunction
{
	...
	*/
	...
	XWDDockletBounce,
	/*
		Bounce icon of the docklet

		XWDId - docklet's identificator
		XWDUInt8 - mode of bouncing
			0 - Normal
			1 - Attention
		XWDUInt32 - amount of bouncing, set 0 to repeat forever (only for Attention mode)
	*/

	XWDDockletBounceStop,
	/*
		Stop bouncing icon of the docklet

		XWDId - docklet's identificator
	*/

	XWDDockletIsBouncing,
	/*
		Check if the docklet's icon is bouncing now

		XWDId - docklet's identificator
		XWDBool* - result
	*/

	XWDDockletGetSettingsPath,
	/*
		Return settings path of the plugin
